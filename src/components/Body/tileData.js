const tileData = [
  {
    ...
    summary: `11일(현지 시각) 온라인으로 개막한 세계 최대 IT(정보 기술) 전시회 ‘CES 2021’은 코로나 팬데믹(대유행)이 산업과 기술 발전의 방향을 바꿔놓았다는 것을 보여주는 거대한 전시장이 되고 있다.\n 소비자 가전 전시회를 뜻하는 CES(Consumer Electronics Show)가 올해는 ‘코로나 일렉트로닉스 쇼(Covid Electronics Show)’가 됐다는 말까지 나온다.`,
    // cols: 2,
  },
  {
    news_agency: '연합뉴스TV',
